...
const _sfc_main = {
  ...
  data() {
    return {
      ...
      isError: false,
      // 图片加载失败
      elIndex: uni_modules_uviewPlus_libs_function_index.guid()
    };
  },
  computed: {
    // 将threshold从rpx转为px
    ...
    imgHeight() {
      return uni_modules_uviewPlus_libs_function_index.addUnit(this.height);
    }
  },
  created() {
    this.observer = {};
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-8b9e8d2e"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/uview-plus/components/u-lazy-load/u-lazy-load.js.map
